...
## Couldn't find SteamVR
This issue sometimes occurs when SteamVR isn't in the default location, or if it has been moved.
You can fix it by following these steps:

- Open Steam
- Right Click SteamVR in your library
- Manage -> Browse local files
- Copy the file path at the top of the window
- Go to your Oculus Dash folder (where OculusDash.exe is)
- Right click -> New -> Text Document
- Name it exactly "location.txt"
- Paste the SteamVR path that you copied
- Save
